...
//    val dev1: Array[AnyRef] = Array("server-1", "https://olympus.ncody.com:443", emptyData, "1", ord1, "0")
//    val dev2: Array[AnyRef] = Array("server-2", "https://olympus.ncody.com:443", emptyData, "0", ord2, "1")
